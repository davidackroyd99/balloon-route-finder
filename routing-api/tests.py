...
from square_repository import get_square_column, get_surrounding_area, get_landing_zones
import math as m
...
data = get_surrounding_area(-50000,70000)
print(get_landing_zones(data))